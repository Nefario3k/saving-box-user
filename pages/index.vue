<template>
  <v-main>
        ...
        <div class="dashboardRow row">
          ...
          <div class="col-12 col-md-7 col-lg-7 col-xl-7">
            <div class="wallet-container">
              <div class="row">
                <div class="p-0 col-12 col-sm-7 wallet-amount">
                  ...
                  <p class="d-flex align-center">
                    <span class="mr-4">
                      {{ showAmount ? "₦ 340,598,980" : "************" }}
                    </span>
                    <v-icon @click="showAmount = !showAmount" style="
                            font-weight: bold;
              ...
              <div class="wallet-actions">
                <v-btn color="var(--primary-color)" @click="$refs.rightDraw.showPanel()" class="Btn fund_wallet">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 6V0H8V6H14V8H8V14H6V8H0V6H6Z" fill="white" />
                  </svg>
                  <span>Fund Wallet</span>
                </v-btn>
                <v-btn @click="$refs.rightDrawThird.showPanel()" class="Btn send_money">
                ...
                <v-btn color="var(--green)" @click="$refs.rightDrawSecond.showPanel()" class="Btn withdraw">
            ...
            <div class="stats-container">
              ...
              <div class="stats__wrapper">
                ...
                <div class="active-savings d-flex">
                  ...
                  <div class="saving-info ml-0 ml-md-4 mt-2 mt-md-0 flex-grow-1">
                ...
                <!-- investment  -->
                <div class="active-savings investment d-flex flex-wrap flex-column flex-md-row">
                  <div class="img d-flex align-center">
                ...
                <!-- loan  -->
                <div class="active-savings loan d-flex flex-wrap flex-column flex-md-row">
                  <div class="img d-flex align-center">
                ...
                <!-- jolly -->
                <div class="active-savings jolly d-flex flex-wrap flex-column flex-md-row">
                  <div class="img d-flex align-center">
          ...
          <div class="col-12 col-md-5 col-lg-5 col-xl-5">
            <div class="invoice-card">
              ...
              <v-tabs :show-arrows="false" v-model="paymentTab" background-color="transparent" color="basil" grow
                class="v-tabs-styles">
              ...
              <v-tabs-items v-model="paymentTab" style="
                      padding-left: 10px;
                      padding-right: 10px;
                      min-height: 300px;
    ...
    <RightDrawer ref="rightDraw" :showDrawer="isFundingWallet" @closeDrawer="isFundingWallet = false">
      <fund-wallet />
    </RightDrawer>
    <RightDrawer ref="rightDrawSecond" :showDrawer="isWithdrawing" @closeDrawer="isWithdrawing = false">
      <withdraw-cash />
    </RightDrawer>
    <RightDrawer ref="rightDrawThird" :showDrawer="isSendingMoney" @closeDrawer="isSendingMoney = false">
      <send-money />
    </RightDrawer>
    <!-- </div> -->
  </v-main>
