      ...
      <div class="singleSavingRow row">
        ...
        <div class="col-12 col-md-5">
          <div class="invoice-card">
            <h1 class="invoice-card-title">Recent Invoice and Payments</h1>
...
<script>
import AutoboxCard from "@/components/savings/autobox/AutoboxCard.vue";
...
import CreateAutoboxForm from "@/components/savings/autobox/CreateAutoboxForm.vue";
