<template>
  <div>
    ...
    <!-- step 1 -->
    <section v-if="stepInfo.step == 1" class="">
      <!-- <div class="back-btn">
        <a href="" @click.prevent="stepInfo.step = --stepInfo.step"><i class="fa-solid fa-arrow-left"></i> Back</a>
      </div> -->
      ...
      <div class="col-12">
        ...
        <div class="input-group">
          <span class="input-group-text input-design"><v-icon>mdi-tray-arrow-up</v-icon></span>
      ...
      <div class="col-12" style="margin-top: 100px">
        <button class="btn btn-primary btn-design" @click.prevent="stepInfo.step = ++stepInfo.step">
          Continue
        </button>
      </div>
    </section>
    ...
    <section v-if="stepInfo.step == 2" class="">
      ...
      <div class="right-drawer-title">
        ...
        <p>Federal Employment details & documents</p>
      </div>

      <div class="col-12">
        <label for="exampleFormControlInput1" class="form-label label-design">Government office name</label>
        <select class="form-select input-design">
          <option value="">Ministry of Works</option>
          <option value="">Ministry of Works</option>
        </select>
      </div>
      <div class="col-12">
        <label for="exampleFormControlInput1" class="form-label label-design">Office Address</label>
        <div class="input-group mb-3">
          <input type="text" placeholder="Business Address" class="form-control input-design"
      ...
      <div class="col-12">
        ...
        <div class="input-group mb-3">
          <input type="text" placeholder="Gross salary" class="form-control input-design"
      ...
      <div class="col-12">
        ...
        <div class="input-group mb-3">
          <input type="text" placeholder="Net salary" class="form-control input-design" aria-label="Enter Net salary" />
        </div>
      </div>
    ...
    <section v-if="stepInfo.step == 4" class="">
      ...
      <div class="right-drawer-title">
        <h1>Loan Summary</h1>
        <p>Salary Earners' loan</p>
      </div>
      <UploadedFilesSummary :uploadedFiles="uploadedFiles"></UploadedFilesSummary>
...
import UploadedFilesSummary from "../UploadedFilesSummary.vue";
export default {
  components: {
    RightDrawer,
    BioDataFields,
  ...
  data() {
    return {
      ...
      uploadedFiles: [
        { name: 'Uploaded Pay Slip', status: true },
        { name: '3 Months Bank Statement', status: true },
      ]
    };
  },
  methods: {
...
@import url('@/static/css/file-input.css');
